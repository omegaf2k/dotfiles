...
"----------------------------------------------------------
"""""""ヘルプをgitから
helptags ~/.vim/bundle/vimdoc-ja
set helplang=ja,en

"----------------------------------------------------------
"""""""howm

""set runtimepath+=/Users/omega/Dropbox/sync/qfixapp
set runtimepath+=~/.bundle/qfixapp

"キーマップ
let QFixHowm_Key = 'g'
let howm_dir = '/Users/omega/Dropbox/sync/qfixapp/howm'
""let howm_dir             = '~/howm'
...
NeoBundle "https://github.com/mojako/ref-alc.vim.git"
